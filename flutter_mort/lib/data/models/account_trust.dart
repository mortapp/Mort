...
class TeenVerificationStatus {
  const TeenVerificationStatus({
    ...
    required this.schoolIdRequired,
    required this.schoolEmailRequired,
    required this.status,
    required this.schoolEmailVerified,
    required this.schoolIdStatus,
    required this.ageStatus,
    required this.identityStatus,
    required this.productionCollectionEnabled,
    required this.rawDocumentPublic,
    required this.schoolNamePublic,
    this.sessionId,
    this.ageBand,
    this.decisionCode,
    this.submittedAt,
  ...
  factory TeenVerificationStatus.fromMap(Map<String, dynamic> map) {
    return TeenVerificationStatus(
      mode: _text(map['mode'], fallback: 'disabled'),
      environment: _text(map['environment'], fallback: 'production'),
      submissionsEnabled: map['submissions_enabled'] == true,
      schoolIdRequired: map['school_id_required'] != false,
      schoolEmailRequired: map['school_email_required'] != false,
      sessionId: map['session_id'] as String?,
      status: _text(map['status'], fallback: 'not_started'),
      ageBand: map['age_band'] as String?,
      schoolEmailVerified: map['school_email_verified'] == true,
      schoolIdStatus: _text(map['school_id_status'], fallback: 'required'),
      ageStatus: _text(map['age_status'], fallback: 'unresolved'),
      identityStatus: _text(map['identity_status'], fallback: 'unresolved'),
      decisionCode: map['decision_code'] as String?,
      submittedAt: map['submitted_at'] as String?,
      reviewedAt: map['reviewed_at'] as String?,
      verifiedAt: map['verified_at'] as String?,
      expiresAt: map['expires_at'] as String?,
      productionCollectionEnabled: map['production_collection_enabled'] == true,
      rawDocumentPublic: map['raw_document_public'] == true,
      schoolNamePublic: map['school_name_public'] == true,
    );
  }
  ...
  final bool schoolIdRequired;
  final bool schoolEmailRequired;
  final String? sessionId;
  final String status;
  final String? ageBand;
  final bool schoolEmailVerified;
  ...
  final String? expiresAt;
  final bool productionCollectionEnabled;
  final bool rawDocumentPublic;
  final bool schoolNamePublic;

  bool get hasSession => sessionId != null && sessionId!.isNotEmpty;
  bool get verified =>
      status == 'verified' &&
      schoolEmailVerified &&
      schoolIdStatus == 'reviewed' &&
      ageStatus == 'verified' &&
