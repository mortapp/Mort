-- Cover common emergency, grooming, verification, and account-deletion wording
-- without allowing the optional provider to see higher-risk messages.
...
begin
  if v_message ~ '(suicid|kill myself|kill me|hurt myself|self.?harm|kill (him|her|them|someone)|kidnap|abduct|traffick|weapon|gun|knife|immediate danger|being followed right now|sexual assault|rape|won.?t let me leave|trapped at (the )?job|\bcsam\b|child pornography|underage nude)' then
    v_level := 3;
