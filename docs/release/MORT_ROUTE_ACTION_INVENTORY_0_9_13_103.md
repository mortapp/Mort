# MORT Route and Action Inventory 0.9.13+103

Generated from application source by `scripts/build-route-action-inventory.mjs`.

| Metric | Result |
|---|---:|
| Authoritative Flutter routes | 188 |
| Expo reference routes | 46 |
| Unresolved Flutter builders | 0 |
| Flutter routes without a direct static test reference | 132 |
...
- `docs/release/MORT_ROUTE_ACTION_INVENTORY_0_9_13_103.csv`
- `docs/release/MORT_ROUTE_ACTION_INVENTORY_0_9_13_103.json`
