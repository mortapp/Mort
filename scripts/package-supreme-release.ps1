...
$apk = Join-Path $root "build\play\mort-closed-test-$artifactVersion.apk"
$aab = Join-Path $root "build\play\mort-closed-test-$artifactVersion.aab"
$apkManifest = Join-Path $root "build\play\mort-closed-test-$artifactVersion-apk-build-manifest.json"
$aabManifest = Join-Path $root "build\play\mort-closed-test-$artifactVersion-aab-build-manifest.json"
