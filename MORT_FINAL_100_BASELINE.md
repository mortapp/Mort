...
JAVA_VERSION=OpenJDK 17.0.17 (Microsoft build) via JAVA_HOME — correctly used by Flutter's Android toolchain for AGP 8.11.1/Gradle 8.14. (System PATH `java` is a stale 1.8.0_481, but Flutter does not use it — verified via `flutter doctor -v`.)
