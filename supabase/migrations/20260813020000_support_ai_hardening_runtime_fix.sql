-- Forward-only support AI classifier correction.
--
-- The earlier migration had already been applied remotely, so this file keeps the
-- historical migration intact and adds a new incremental fix to the live SQL
-- classifier without rewriting production history.
