# MORT Route and Action Inventory 0.9.4

Generated from application source by `scripts/build-route-action-inventory.mjs`.

| Metric | Result |
|---|---:|
| Authoritative Flutter routes | 175 |
| Expo reference routes | 46 |
| Unresolved Flutter builders | 4 |
| Flutter routes without a direct static test reference | 142 |
