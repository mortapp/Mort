...
-- ---------------------------------------------------------------------------
-- 2. Service-role wrapper so evaluation/gauntlet tooling grades the real
--    classifier instead of a maintained-by-hand TypeScript copy.
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 3. Database-backed provider circuit breaker, reusing the existing
--    `support_global_rate_limits` table introduced for the daily provider
--    budget rather than adding a new table.
-- ---------------------------------------------------------------------------
