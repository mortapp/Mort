...
$stageRoot = Join-Path $root 'build\package-secure-session-persistence-0.9.10'
$zipPath = Join-Path $artifactDirectory 'mort-secure-session-persistence-0.9.10-source-clean.zip'
$excludedSegments = @(
